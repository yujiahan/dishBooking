...
class HomeController extends Controller {
  async index() {
    this.ctx.body = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="theme-color" content="#000000">'+
                    '<meta name="apple-mobile-web-app-capable" content="yes">'+
                    '<meta name="apple-mobile-web-app-status-bar-style" content="black">'+
                    '<meta name="apple-mobile-web-app-title" content="Weather PWA">'+
                    '<link rel="apple-touch-icon" href="http://jiao-tang.com:7001/public/logo.png">'+
                    '<link rel="manifest" href="/public/manifest.json"> '+ 
                    '<link rel="shortcut icon" href="http://jiao-tang.com:7001/public/logo.png">'+
